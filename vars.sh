...
export FEATHERCR="$FEATHER_PATH/config-ref"
export FEATHERCRD="$FEATHERCR/deployed"
...
export FEATHERTL="$FEATHER_PATH/templates"
export FEATHERX="$FEATHER_PATH/textual"
export FEATHERSTATE="$FEATHERH/state"
export FEATHERM="$FEATHERS/migrations"
